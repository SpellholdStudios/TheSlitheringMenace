...
![Latest Release](https://img.shields.io/github/v/release/GwendolyneFreddy/TheSlitheringMenace?include_prereleases&color=darkred)<a name="top" id="top">
...
Run **`setup-snakes.command`** in your game folder to reinstall, uninstall or otherwise change the components settings.
...
- Deratiseur: Provided EE compatible version (v3.5).
